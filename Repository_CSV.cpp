...
Repository_CSV::Repository_CSV()
{
}

Repository_CSV::Repository_CSV(string file_name) : Repository(file_name)
{
	this->load_from_file();
}
...
void Repository_CSV::load_from_file() throw(ReadFromFileException)
{
...
void Repository_CSV::save_to_file()
{
